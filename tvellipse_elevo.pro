pro tvellipse_elevo, rmax, rmin, xc, yc, pos_ang, color, DATA = data, $
	NPOINTS = npoints, COLOR=thecolor, MAJOR=major, MINOR=minor, $
        DEVICE= device, FILL = fill, _Extra = _extra
;+
; NAME:
;      TVELLIPSE_elevo (changed from tvellipse.pro in SolarSoft)
;
; PURPOSE:
...
;-
 ...
 ;this makes a bar at the back
 ;phi(0:134)=findgen(135)
 ;phi(135:269)=findgen(135)+225
 phi=phi*!dpi/180.
